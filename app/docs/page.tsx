export default function DocsPage() {
      ...
      <div style={{ 
        ...
        <section style={{ marginBottom: '50px' }}>
          ...
          <div style={{ background: '#f7f7f7', padding: '20px', borderRadius: '8px', marginBottom: '20px' }}>
            ...
            <p>Email <a href="mailto:your@email.com" style={{ color: '#667eea' }}>your@email.com</a> with:</p>
            <ul>
              <li>Your name</li>
  ...
  console.log(\`Saved: $\${data.meta.cost_saved_usd}\`);`}
        ...
        <section style={{ marginBottom: '50px' }}>
          ...
          <p>Questions? Email us at <a href="mailto:your@email.com" style={{ color: '#667eea' }}>your@email.com</a></p>
